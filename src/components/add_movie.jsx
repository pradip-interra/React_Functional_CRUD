...
const AddMovieComponent = (props) => {
  ...
  function toggleModal() {
    setModalStatus(!isModalOpen); // set the value to local component
    props.onToggle(isModalOpen); // notify back to the parent
  }
  ...
  function handleSubmit(formData) {
    ...
    movieApi
      ...
      .then((responseP) => {
        console.log(
          "Movie is added, response from POST: " + responseP.data.toString()
        );
        toggleModal();
        props.onSucces();
      })
      .catch((e) => {
        console.log("Error occured in Movie POST call: " + e);
        setError(true);
      });
  }
